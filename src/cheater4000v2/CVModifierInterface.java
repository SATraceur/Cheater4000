...
public class CVModifierInterface extends javax.swing.JFrame {

    public CVModifierInterface() {
        initComponents();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(XBox, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(YBox, javax.swing.GroupLayout.DEFAULT_SIZE, 87, Short.MAX_VALUE)
                                .addComponent(VBox)))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            CV.x = Integer.parseInt(XBox.getText());
            CV.y = Integer.parseInt(YBox.getText());
        } catch (NumberFormatException e) {
            CV.errorMessage = "Incorrect Coordinate Format";
        }
        CV.varName = VBox.getText();    
        //System.out.println(CV.varName);
    }//GEN-LAST:event_jButton1ActionPerformed

    public CoordinateVariable getCV() {
        return this.CV;
    }
    
    private CoordinateVariable CV = new CoordinateVariable();
